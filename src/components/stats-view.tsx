...
type Props = {
  /** Full archive — used to look up challenge titles for the recent-results list. */
  challenges: Challenge[];
};

export function StatsView({ challenges }: Props) {
  ...
  const titleById = useMemo(() => {
    ...
    for (const c of challenges) m.set(c.id, c.title);
    return m;
  }, [challenges]);
