            ...
            <>
              ...
              <div className="mt-4 space-y-3 text-sm">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-display text-base">{active.player}</span>
                </div>
...
/** Mini static silhouette graphic used as the archive thumbnail. */
    ...
    <div className="absolute inset-0">
      ...
      <svg viewBox="0 0 120 160" className="absolute inset-0 h-full w-full opacity-90">
        {[20, 40, 60, 80, 100, 120, 140].map((y) => (
          <line key={y} x1="0" x2="120" y1={y} y2={y} stroke="#1a1a1a" strokeWidth="1" />
        ))}
